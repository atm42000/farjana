...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2017 at 06:03 AM
...
INSERT INTO `clients` (`clientID`, `modified`, `client`, `notes`, `employeeID`) VALUES
(3, '2017-09-14 00:00:00', 'qqq', 'qqq', 1);
...
(1, '2017-09-14 14:42:48', '03434', 'aaa', 'aaa', 'aaa', 'aaa@df.gd', 'ItÃ¯Â¿Â½s MySQL spatial data week here, though I am spreading out the posts to, um, ease the pain (or boredom). Anyway, here are some commands/functions I donÃ¯Â¿Â½t want to forget about later:\r\n\r\nStart with an existing table called geometry, add a spatial column and index it:\r\n\r\n', 3, 1),
...
(5, '2017-09-14 11:13:26', 'bbb', 'bbb@gmail.com', 'c09269b620a596eb5d49f623eae1b641defc592820d0214aa63b8170162e4192', '54e89c9e4c5ab38c', 0, '2', 1),
...
--
ALTER TABLE `clients`
  MODIFY `clientID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `hostvulns`
  MODIFY `hostvulnID` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `projects`
  MODIFY `projectID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
